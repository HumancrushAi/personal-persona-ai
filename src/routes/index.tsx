...
const BANNERS: { id: string; name: string; title: string; sub: string; gender: "m" | "f" }[] = [
  {
    ...
    sub: "seductive silk dress · penthouse luxury vibes 💋",
    gender: "f",
  },
  {
    ...
    name: "Sofia",
    title: "After hours",
    sub: "sultry lounge · thinking about you 😏",
    gender: "f",
  },
  {
  ...
  },
  {
    ...
    name: "Priya",
    title: "Sultry gaze",
    sub: "exotic beauty · deep midnight connection ✨",
    gender: "f",
  },
  {
    ...
    name: "Nyx",
    title: "Neon nights",
    sub: "mysterious goth queen · industrial beats 💋",
    gender: "f",
  },
  {
